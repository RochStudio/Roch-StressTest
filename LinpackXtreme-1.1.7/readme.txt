Linpack Xtreme v1.1.8 by Regeneration
...
v1.1.6
- Residual checks are now enabled by default for Intel processors without
AVX2 support. Residual checks can forced or disabled by using the following
command-line switches: /noresidualcheck or /residualcheck.
